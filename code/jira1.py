...
diretorio = 'https://dalek.mot.com/'


jira = JIRA(server=diretorio, auth=('laissf', 'Abre2503'))
issues = jira.issue('MCA-370052')

# Summaries of my last 3000 reported issues
...
#project = 11010 AND issuetype = "Test Case" AND labels = TMO_Reg AND labels = Plat_Reg AND status != closed