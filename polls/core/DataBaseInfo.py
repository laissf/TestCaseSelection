...
def createBD():
    #CORE APPS
    core_apps = QueryType()
    core_apps.type = "Core Apps"
    core_apps.save()

    core_apps.filters_set.create(plan="CoreApps Common", filter="CoreApps_Common_Q_Singleline", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = Common_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="Message AOSP", filter="	AOSP_Message_Q_Singleline", query='project in ("MD Communication Archtest", COREAPPS, "FW UI", "FW HAL", "Carrier Customization Test") AND labels = AOSP_Message AND issuetype = "Test Case" AND status != closed')
    core_apps.filters_set.create(plan="Message GMS", filter="GMS_Message_Q_Singleline", query='project in ("MD Communication Archtest", COREAPPS, "FW UI", "FW HAL", "Carrier Customization Test") AND labels = GMS_Message AND issuetype = "Test Case" AND status != closed')
    core_apps.filters_set.create(plan="Contacts/Dialer AOSP", filter="AOSP_Dialer/Contacts_Q_Singleline", query='project in ("MD Communication Archtest", COREAPPS, "FW UI", "FW HAL", "Carrier Customization Test") AND labels in (AOSP_Contacts, AOSP_Dialer) AND issuetype = "Test Case" AND status != closed')
    core_apps.filters_set.create(plan="Contacts/Dialer GMS", filter="GMS_Dialer/Contacts_Q_Singleline", query='project in ("MD Communication Archtest", COREAPPS, "FW UI", "FW HAL", "Carrier Customization Test") AND labels in (GMS_Contacts, GMS_Dialer) AND issuetype = "Test Case" AND status != closed')
    core_apps.filters_set.create(plan="CoreApps VZW", filter="	CoreApps_VZW_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = VZW_Reg AND labels != non-vzw AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps TMO", filter="CoreApps_TMO_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = TMO_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps ATT", filter="CoreApps_ATT_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = ATT_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps Sprint", filter="CoreApps_Sprint_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = Sprint_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps Latam", filter="CoreApps_Latam_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = Latam_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps APAC", filter="CoreApps_APAC_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = APAC_Reg AND status != closed ORDER BY cf[10104] ASC')
    core_apps.filters_set.create(plan="CoreApps RetUS", filter="CoreApps_RetUS_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = RetUS_Reg AND status != closed ORDER BY cf[10104] ASC')

    #FW HAL
    fw_hal = QueryType()
    fw_hal.type = "FW - HAL&UI"
    fw_hal.save()
    fw_hal.filters_set.create(plan="CoreApps FI", filter="CoreApps_Fi_Reg", query='project in (COREAPPS, "Carrier Customization Test") AND issuetype = "Test Case" AND labels = CoreApps_Reg AND labels = Fi_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL Common", filter="FWHAL_Common_Q_Singleline", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = Common_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL VZW", filter="FWHAL_VZW_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = VZW_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL TMO", filter="	FWHAL_TMO_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = TMO_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL ATT", filter="FWHAL_ATT_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = ATT_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL Sprint", filter="FWHAL_Sprint_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = Sprint_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL Latam", filter="FWHAL_Latam_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = Latam_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL RetUS", filter="FWHAL_RetUS_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = RetUS_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL APAC", filter="FWHAL_APAC_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = APAC_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - HAL Fi", filter="FWHAL_Fi_Reg", query='project = "FW HAL" AND issuetype = "Test Case" AND labels = FWHAL_Reg AND labels = Fi_Reg AND status != closed ORDER BY cf[10104] ASC')
    fw_hal.filters_set.create(plan="FW - UI", filter="FWUI_Common_Q_Singleline", query='project = "FW UI" AND issuetype = "Test Case" AND labels = FWUI_Reg AND labels = Common_Reg AND status != closed ORDER BY cf[10104] ASC')

    #PLATFORM REG
    plat_reg = QueryType()
    plat_reg.type = "Platform Reg"
    plat_reg.save()
    plat_reg.filters_set.create(plan="Core Reg", filter="Core_Reg_Q_Singleline", query='project = 11010 AND issuetype = "Test Case" AND labels = Core_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="DSDS", filter="DSDS_Reg", query='project in ("MD Communication Archtest", COREAPPS, "FW UI", "FW HAL", "Carrier Customization Test") AND labels = DSDS_Reg AND labels = Plat_Reg AND issuetype = "Test Case" AND status != closed')
    plat_reg.filters_set.create(plan="GMS Reg", filter="GMS_Reg_Q_Singleline", query='project = 11010 AND issuetype = "Test Case" AND labels = GMS_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="VZW Reg", filter="VZW_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = VZW_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="TMO Reg", filter="TMO_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = TMO_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="MPCS Reg", filter="MPCS_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = MPCS_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="REVVL_Reg", filter="REVVL_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels in (TMO_Reg, REVVL_Reg) AND labels = Plat_Reg AND status != closed')
    plat_reg.filters_set.create(plan="ATT Reg", filter="ATT_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = ATT_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Cricket Reg", filter="Cricket_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Cricket_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Sprint Reg", filter="Sprint_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Sprint_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Latam Reg", filter="Latam_Reg", query='project = MCA AND labels = Latam_Reg AND labels = Plat_Reg AND issuetype = "Test Case" AND status != closed')
    plat_reg.filters_set.create(plan="APAC Reg", filter="APAC_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = APAC_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="RetUS Reg", filter="RetUS_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = RetUS_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="FI Reg", filter="Fi_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Fi_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="UCS Reg", filter="	USC_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = USC_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Comcast Reg", filter="Comcast_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Comcast_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Conscell Reg", filter="ConsCell_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = ConsCell_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="RW Reg", filter="Republic_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Republic_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Tracfone Reg", filter="Tracfone_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Tracfone_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Visible Reg", filter="Visible_Reg", query='project = 11010 AND issuetype = "Test Case" AND labels = Visible_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Google Pay", filter="GPay_Reg_Singleline", query='project = 11010 AND issuetype = "Test Case" AND labels = GPay_Reg AND labels = Plat_Reg AND status != closed ORDER BY cf[10104] ASC')
    plat_reg.filters_set.create(plan="Android Auto", filter="Android_Auto_Reg", query='labels = Plat_Reg AND labels = Android_Auto_Reg AND issuetype = "Test case"')

    # GPSU
    gpsu = QueryType()
    gpsu.type = "GPSU"
    gpsu.save()
    gpsu.filters_set.create(plan="GPSU Sanity", filter="gpsu_sanity", query='project = 11010 AND issuetype = "Test Case" AND labels = gpsu_sanity')
    gpsu.filters_set.create(plan="GPSU Infra", filter="gpsu_infra", query='project = 11010 AND issuetype = "Test Case" AND component = Infra')
    gpsu.filters_set.create(plan="GPSU Watchdog", filter="gpsu_watchdog", query='project = 11010 AND issuetype = "Test Case" AND component = Watchdog')
    gpsu.filters_set.create(plan="GPSU OTA", filter="gpsu_ota ", query='project = 11010 AND issuetype = "Test Case" AND labels = gpsu_ota')
